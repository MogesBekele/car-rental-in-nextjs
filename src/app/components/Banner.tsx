  ...
  return (
    ...
    >
      <div className="text-white">
        <h2 className="text-3xl font-medium">ከፍተኛ ጥራት መኪና ይዞታ አለዎት?</h2>
        <p className="mt-2">መኪናዎን በቀላሉ ገቢ ያድርጉ፤ በCarRental ላይ ይመዝገቡ።</p>
        <p className="max-w-130">
          የኢንሹራንስ፣ የአሽከርካሪ ማረጋገጫ እና የደህንነት ክፍያ ሁሉንም እኛ እንወስዳለን፤ እርስዎም ያለ ጭንቀት
          የተረጋጋ ገቢ ይኖርዎታል።
        </p>
        <motion.button
